...
_raw_allowed = config('ALLOWED_HOSTS', default='169.58.136.166,kikuyu-campus-website.onrender.com,.onrender.com,helasabili.co.ke,127.0.0.1,localhost', cast=str)
if _raw_allowed:
...
_raw_csrf = config('CSRF_TRUSTED_ORIGINS', default='https://kikuyu-campus-website.onrender.com,https://helasabili.co.ke,http://127.0.0.1:8000,http://localhost:8000', cast=str)
if _raw_csrf:
...
PRODUCTION_HOST = 'helasabili.co.ke'
...
# Email Configuration
# Read SMTP settings; use SMTP backend only when credentials are provided, otherwise fall back to console backend for safe local testing.
EMAIL_HOST = config('EMAIL_HOST', default='smtp.gmail.com')
EMAIL_PORT = config('EMAIL_PORT', default=587, cast=int)
EMAIL_USE_TLS = config('EMAIL_USE_TLS', default=True, cast=bool)

# Credentials (empty by default)
EMAIL_HOST_USER = config('EMAIL_HOST_USER', default='helasabilimobilecapital@gmail.com')
EMAIL_HOST_PASSWORD = config('EMAIL_HOST_PASSWORD', default='hyhl lggi gowe nrrk')

# Choose backend: SMTP only when both user and password are provided
