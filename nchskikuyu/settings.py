...
_raw_allowed = config('ALLOWED_HOSTS', default='104.105.8.211,kikuyu-campus-website.onrender.com,.onrender.com,app.helasabili.co.ke,127.0.0.1,localhost', cast=str)
if _raw_allowed:
...
PRODUCTION_HOST = 'app.helasabili.co.ke'
