...
urlpatterns = [
    ...
    path('listings/<int:pk>/', views.course_detail, name='courses_detail'),
    path('course/<int:pk>/', RedirectView.as_view(pattern_name='website:courses_detail', permanent=False), name='legacy_course_detail_redirect'),
